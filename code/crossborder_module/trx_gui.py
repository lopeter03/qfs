# trx_gui.py
# Transparent Transaction GUI Demo with Smart Contract Box
...
# Smart Contract Box
st.subheader("📦 Smart Contract Box")
if st.button("Add Transaction"):
    result, error_msg = st.session_state.qfs_chain.add_transaction(sender, receiver, amount, asset_type)
    if result:
        st.success("Transaction added under Smart Contract rules ✔")
    else:
